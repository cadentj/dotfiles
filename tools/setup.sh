...
echo "    --api-key ${SPRITE_AUTH_TOKEN}"
echo
echo "# Google Tasks MCP: on the sprite set e.g."
echo "#   GOOGLE_TASKS_CLIENT_SECRETS_JSON=/home/sprite/client_secret....json"
echo "#   GOOGLE_TASKS_TOKEN_JSON=/home/sprite/google-tasks-token.json   # {\"refresh_token\":\"...\"}"
echo "# (or flat GOOGLE_TASKS_CREDENTIALS_JSON). See google-tasks-mcp.py docstring."
